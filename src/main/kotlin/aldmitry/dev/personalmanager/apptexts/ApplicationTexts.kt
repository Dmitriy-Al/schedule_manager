...
const val text_limitPartOne = "\uD83D\uDD30  Лимит добавления клиентов исчерпан. В период времени, когда абонемент не активирован, специалист может зарегистрировать до "

const val text_limitPartTwo = " клиентов, активация абонемента увеличивает лимит до "
