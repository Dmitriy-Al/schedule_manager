...
const val text_backupDataPartOne = "\uD83D\uDD30  Бэкап-файл данных с расширением .xml будет создан в директории по умолчанию: "
...
const val text_uploadToServer = "\uD83D\uDD30  backup серверов (при наличии!) будет выгружен в admin-чат Telegram из директории по умолчанию после нажатия клавиши <По умолчанию>. Также путь к backup (например: C:/) можно отправить в чат и выгрузить файлы из указанной директории."
...
const val text_findClientToAppointment = "\uD83D\uDD30 Чтобы найти клиента для записи на приём, нажмите клавишу с первой буквой фамилии, или введите первую букву/несколько первых букв фамилии клиента и отправьте сообщение в чат."
...
const val text_passwordApprove = "✅ Код был подтверждён, осталось заполнить ФИО и регистрация будет завершена. Введите, пожалуйста, фамилию клиента или ФИО полностью (например: Иванов Иван Иванович) и отправьте сообщение в чат."
...
const val text_clientStartMessage = "Здравствуйте, уважаемый пользователь! Здесь вы можете получать информацию о предстоящем визите к своему специалисту. Для этого, если вам был сообщён короткий код, введите его и отправьте сообщение в чат."
...
const val text_addNewClient = "\uD83D\uDD30  Если ваш клиент/пациент использует Telegram, вы можете сообщить ему имя бота, которое надо ввести в строку поиска Telegram: $text_personalClientManager. Из списка предложенных программ выбрать $text_personalManager." +
...
const val text_paymentTextOne = "\uD83D\uDD30  Оплата абонемента позволяет использовать полный функционал приложения в течение "

const val text_paymentTextTwo = " дней. Стоимость абонемента составляет "

const val text_paymentTextThree = " рублей. Оплачивая абонемент, вы получаете возможность редактировать данные уже добавленных клиентов и добавлять новых клиентов вплоть до ограничения в "
